...
export const Error = (): JSX.Element => {
  ...
  return (
    <section className="h-screen flex flex-col items-center justify-center gap-10 dark:bg-gray-800 ">
        ...
        <p className="text-4xl sm:text-6xl text-blue-600 dark:text-white">PAGE NOT FOUND</p>
        ...
        <button onClick={handleNavigate} className="border-[2px] border-blue-600 rounded-full px-10 py-2 text-blue-600 font-semibold outline-none dark:text-white">Go Back</button>
    </section>
  )
}
