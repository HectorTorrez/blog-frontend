export const Email = (): JSX.Element => {
  return (
    <svg className="w-5 h-5 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
...
export const MobileNavIcon = (): JSX.Element => {
  return (
...
export const User = (): JSX.Element => {
  return (
    <svg className="w-5 h-5 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 18">
