  ...
  return (
    ...
    <section className=" bg-white min-w-[302px] border mx-2 border-gray-200 rounded-lg shadow-md sm:w-screen md:max-w-sm dark:bg-gray-800 dark:border-gray-700 max-h-[250px] ">
        <header className='text-red-600 flex justify-end mx-3 mt-3'>
          <button data-cy="deleteBlog" onClick={() => {
        ...
        <div className="p-5 pt-0 min-w-[236px]">
            ...
            <Link to={`/blogs/${id}`} data-cy="readMore" className="inline-flex items-center  px-3 py-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
                <RightArrow/>
            </Link>
        </div>
